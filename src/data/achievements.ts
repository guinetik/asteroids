...
export const ACHIEVEMENT_DEFINITIONS: readonly AchievementDefinition[] = [
  ...
  {
    id: 'cosmetics-habitat-paint-first-paid',
    category: 'cosmetics',
    icon: '\u{1F58C}\u{FE0F}',
    title: 'WALLS WITH OPINIONS',
    subtitle: 'Habitat paint · first themed cabin makeover',
    description: 'Buy your first premium habitat interior paintjob at Pimp My Shuttle.',
    type: 'PIMP MY SHUTTLE',
    rewardCredits: REWARD_STARTER,
    kind: 'cosmetic_paid_owned_count',
    cosmeticCategory: 'habitat-interior',
    threshold: FIRST_COUNT,
  },
  {
    id: 'cosmetics-habitat-paint-complete',
    category: 'cosmetics',
    icon: '\u{1F3E0}',
    title: 'INTERIOR DESIGNER',
    subtitle: 'Every cabin theme on standby',
    description: 'Own every habitat interior paintjob listed at Pimp My Shuttle.',
    type: 'PIMP MY SHUTTLE',
    rewardCredits: REWARD_COSMETIC_COMPLETE,
    kind: 'cosmetic_full_collection',
    cosmeticCategory: 'habitat-interior',
  ...
  {
    id: 'cosmetics-habitat-furniture-first-paid',
    category: 'cosmetics',
    icon: '\u{1FA91}',
    title: 'FIRST FURNISHING',
    subtitle: 'Habitat furniture · first appliance bolted in',
    description: 'Buy your first habitat furniture appliance at Pimp My Shuttle.',
    type: 'PIMP MY SHUTTLE',
    rewardCredits: REWARD_STARTER,
    kind: 'cosmetic_paid_owned_count',
    cosmeticCategory: 'habitat-furniture',
    threshold: FIRST_COUNT,
  },
  {
    id: 'cosmetics-habitat-furniture-complete',
    category: 'cosmetics',
    icon: '\u{1F3D8}\u{FE0F}',
    title: 'FULLY FURNISHED',
    subtitle: 'Every cabin appliance unlocked',
    description: 'Own every habitat furniture appliance listed at Pimp My Shuttle.',
    type: 'PIMP MY SHUTTLE',
    rewardCredits: REWARD_COSMETIC_COMPLETE,
    kind: 'cosmetic_full_collection',
    cosmeticCategory: 'habitat-furniture',
