...
export const MINERAL_VISUALS: Record<string, MineralVisual> = {
  ...
  'Organic Compounds': { color: [0.1, 0.07, 0.04], metalness: 0.0, roughness: 0.95, emissive: false },
  ...
  'Plagioclase Feldspar': { color: [0.7, 0.7, 0.68], metalness: 0.05, roughness: 0.65, emissive: false },
  'Iron-Nickel Alloy': { color: [0.77, 0.78, 0.8], metalness: 0.85, roughness: 0.3, emissive: false },
  ...
  'Carbon Dioxide Ice': { color: [0.95, 0.95, 0.97], metalness: 0.0, roughness: 0.2, emissive: false },
  'Ammonia Hydrate': { color: [0.75, 0.82, 0.92], metalness: 0.0, roughness: 0.25, emissive: false },
