...
/** Square pixel size for static shuttle shop thumbnails. */
export const SHUTTLE_COSMETIC_PREVIEW_SIZE_PX = 512

/** PNG MIME type used for Vue-safe shuttle preview data URLs. */
export const SHUTTLE_COSMETIC_PREVIEW_MIME_TYPE = 'image/png'

/** Preview camera field-of-view in degrees. */
export const SHUTTLE_COSMETIC_PREVIEW_FOV_DEG = 38

/** Preview camera near plane in model-space units. */
export const SHUTTLE_COSMETIC_PREVIEW_NEAR = 0.1

/** Preview camera far plane in model-space units. */
export const SHUTTLE_COSMETIC_PREVIEW_FAR = 100000
...
/** Background color behind the shuttle thumbnail. */
export const SHUTTLE_COSMETIC_PREVIEW_BACKGROUND = '#080b16'

/** Low ambient fill so dark hull panels remain readable. */
export const SHUTTLE_COSMETIC_PREVIEW_AMBIENT_INTENSITY = 1.6

/** Main key light intensity for the static shop thumbnail. */
export const SHUTTLE_COSMETIC_PREVIEW_KEY_INTENSITY = 3.4

/** Cool rim light intensity to reveal the shuttle silhouette. */
export const SHUTTLE_COSMETIC_PREVIEW_RIM_INTENSITY = 1.8
...
export const MAP_INTRO_MARS_PHOBOS_CAMERA_OFFSET = new THREE.Vector3(1.4, 0.6, 3.1)
export const MAP_INTRO_MARS_PHOBOS_FOV = 40
...
/** Luna is Earth's first moon in the catalog. */
export const EARTH_MOON_INDEX = 0

/** Earth-Moon intro framing. */
export const MAP_INTRO_MOON_CAMERA_OFFSET = new THREE.Vector3(3.8, 1.2, 11.5)
export const MAP_INTRO_MOON_FOV = 34

/** Saturn intro framing. */
export const MAP_INTRO_SATURN_CAMERA_OFFSET = new THREE.Vector3(18, 10, 82)
export const MAP_INTRO_SATURN_FOV = 42
...
export const MAP_VIEW_CONTROLLER_CONFIG = {
  ...
  SHUTTLE_COSMETIC_PREVIEW_CAMERA_OFFSET,
  SHUTTLE_COSMETIC_PREVIEW_FAR,
  SHUTTLE_COSMETIC_PREVIEW_FOV_DEG,
  SHUTTLE_COSMETIC_PREVIEW_KEY_INTENSITY,
  SHUTTLE_COSMETIC_PREVIEW_MIME_TYPE,
  SHUTTLE_COSMETIC_PREVIEW_MIN_CAMERA_DISTANCE,
  SHUTTLE_COSMETIC_PREVIEW_NEAR,
  SHUTTLE_COSMETIC_PREVIEW_RIM_INTENSITY,
  SHUTTLE_COSMETIC_PREVIEW_SIZE_PX,
  SHUTTLE_COSMETIC_PREVIEW_TARGET,
