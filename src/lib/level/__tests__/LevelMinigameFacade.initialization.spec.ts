  ...
  it('creates objective minigames and wires shared/controller callbacks', async () => {
    ...
    await facade.initializeObjectives({
      ...
      bindings: {
        ...
        onDanScanAudioState: vi.fn(),
        onDanParticleHit: vi.fn(),
        onDanCompletionPulse: vi.fn(),
        onDamagePlayer,
        onKillPlayer,
        onDestroyLander,
        onExplosion,
    ...
    expect(rescue.onSurvivorRevived).toBe(onSurvivorRevived)
