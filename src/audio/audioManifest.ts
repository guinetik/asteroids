...
const manifestById: ManifestById = {
  ...
  'sfx.breathing.hard': {
    id: 'sfx.breathing.hard',
    src: '/sound/sfx.breathing.hard.mp3',
    category: 'sfx',
    load: 'lazy',
    playback: 'single-instance',
    volume: 0.48,
  ...
  'sfx.cat.meow.pet': {
    id: 'sfx.cat.meow.pet',
    src: '/sound/sfx.cat.meow.pet.mp3',
    category: 'sfx',
    load: 'lazy',
    playback: 'restart',
    volume: 0.75,
  ...
  'sfx.cat.meow.variant': {
    id: 'sfx.cat.meow.variant',
    src: '/sound/sfx.cat.meow.variant.mp3',
    category: 'sfx',
    load: 'lazy',
    playback: 'restart',
    volume: 0.7,
  ...
  'sfx.litter.scoop': {
    id: 'sfx.litter.scoop',
    src: '/sound/sfx.litter.scoop.mp3',
    category: 'sfx',
    load: 'lazy',
    playback: 'restart',
    volume: 0.7,
  ...
  'music.levelCombat': {
    id: 'music.levelCombat',
    src: '/sound/level_combat.mp3',
    category: 'music',
    load: 'lazy',
    playback: 'single-instance',
    volume: 0.25,
  ...
  'music.levelGather': {
    id: 'music.levelGather',
    src: '/sound/level_gather.mp3',
    category: 'music',
    load: 'lazy',
    playback: 'single-instance',
    volume: 0.25,
  ...
  'music.levelRescue': {
    id: 'music.levelRescue',
    src: '/sound/level_rescue.mp3',
    category: 'music',
    load: 'lazy',
    playback: 'single-instance',
    volume: 0.25,
  ...
  'music.levelGravity': {
    id: 'music.levelGravity',
    src: '/sound/level_gravity.mp3',
    category: 'music',
    load: 'lazy',
    playback: 'single-instance',
    volume: 0.25,
